 ...
 *
 */
public class BorrowRemoveScreen implements Screen{
	...
	public BorrowRemoveScreen(Stage primaryStage) {
		...
		submitButton.setOnAction(
				new EventHandler<ActionEvent>() {
					...
					public void handle(final ActionEvent e) {
						BorrowController borrowCtrl = new BorrowController();
						String resultMsg = borrowCtrl.returnBook(bookIdTf.getText());
						
						DialogUtil.basicDialog(resultMsg);
					}
				});
